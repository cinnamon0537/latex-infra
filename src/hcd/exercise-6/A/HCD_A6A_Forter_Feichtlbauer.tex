...
\textbf{Beschreibung:} ``Stell dir vor, ihr plant für \textbf{morgen} ein gemeinsames \textbf{Sporttreffen} in der Nähe. \textbf{Erstelle eine neue Gruppe}, gib ihr einen passenden Titel, setze \textbf{Ort und Uhrzeit} und füge eine kurze Beschreibung hinzu.''\\
\textbf{Erfolgskriterien:} Gruppe sichtbar angelegt, Kernfelder korrekt befüllt.\\
...
\subsection*{T3 – Umfrage/Abstimmung erstellen}
\textbf{Ziel:} Learnability, Memorability.\\
\textbf{Beschreibung:} ``Lege in der Gruppe eine \textbf{Umfrage} an, um zwischen \textbf{zwei Orten} zu entscheiden.''\\
\textbf{Erfolgskriterien:} Umfrage erstellt, zwei Optionen angelegt.\\
...
\textbf{Beschreibung:} ``Das Event ist vorbei. \textbf{Archiviere die Gruppe} oder markiere sie als abgeschlossen.''\\
\textbf{Erfolgskriterien:} Gruppe ist nicht mehr in der aktiven Liste, im Archiv auffindbar.\\
\textbf{Abbruchkriterium:} 3 Minuten.
...
\textbf{UMUX-Lite} (1--7, 1 = stimme gar nicht zu, 7 = stimme voll zu)\\[-0.6em]
\begin{enumerate}
...
\begin{tabularx}{\linewidth}{p{10cm} *{7}{>{\centering\arraybackslash}p{0.9cm}}}
\toprule
 & \multicolumn{7}{c}{\textbf{Antwortskala (1 = gar nicht, 7 = voll)}}\\
\cmidrule(lr){2-8}
\textbf{Item} & 1 & 2 & 3 & 4 & 5 & 6 & 7\\
\midrule
